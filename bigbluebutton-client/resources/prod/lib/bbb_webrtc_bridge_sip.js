/*
 *  WebRTC related calls
 *
 */
(function(window, undefined) {

  var userID, callerIdName=null, conferenceVoiceBridge,
    userAgent=null, userMicMedia, userWebcamMedia, currentSession=null,
    callTimeout, callActive, callICEConnected, iceConnectedTimeout, callFailCounter, callPurposefullyEnded,
    uaConnected, transferTimeout, iceGatheringTimeout;

  var inEchoTest = true;

  var BBBWebRTC = {};

  BBBWebRTC.joinVoiceConference = function(listenOnly, callback) {
  ...
  BBBWebRTC.getCallStatus = function() {
    return currentSession;
  }

  BBBWebRTC.available = function() {
