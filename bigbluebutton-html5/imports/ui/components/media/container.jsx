...
import GenericComponentContainer from '../generic-component/container';
...
export default withModalMounter(withTracker(() => {
  ...
  if (MediaService.shouldShowGenericComponent()) {
    data.children = (
      <GenericComponentContainer
        name={MediaService.getComponentName()}
        url={MediaService.getComponentUrl()}
        isPresenter={MediaService.isUserPresenter()}
      />
    );
  }
